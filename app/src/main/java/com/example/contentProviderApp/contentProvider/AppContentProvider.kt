...
class AppContentProvider : ContentProvider() {
    companion object {
        const val PROVIDER_NAME =
            "com.example.contentProviderApp.contentProvider.CredenceContentProvider"
        const val URL = "content://$PROVIDER_NAME/personalData"
        ...
        const val DATABASE_NAME = "ShareDB"
        const val TABLE_NAME = "PersonalDetails"
        ...
        init {
            ...
            uriMatcher!!.addURI(PROVIDER_NAME, "personalData", uriCode)
            uriMatcher!!.addURI(PROVIDER_NAME, "personalData/*", uriCode)
        }
    }
    ...
    override fun getType(uri: Uri): String? {
        return when (uriMatcher!!.match(uri)) {
            uriCode -> "vnd.android.cursor.dir/personalData"
